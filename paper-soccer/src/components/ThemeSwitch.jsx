...
function ThemeSwitch() {
	...
	return (
		<div className="absolute top-0 right-0 m-6 cursor-pointer" onClick={() => toggleTheme()}>
			{/* Box */}
			<div className="w-20 h-10 border rounded-full border-black dark:border-dark p-[4px] flex">
				{/* Ball */}
